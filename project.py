...
#cur.execute("insert into paymentsf values(1,'KATTA','MURALI','9494366830','muralikatta15@gmail.com',2,'1','11','2018','11:20:27 PM','Cash','3500')")
...
Label(sroot,text="KATTA MURALI",font='Timesnewroman 40 ',bg='white',fg='black').place(x=535,y=180)
#Label(sroot,text="9494366830",font='Timesnewroman 40',bg='white',fg='grey').place(x=535,y=450)
#----------- main project------------------------------------------------------------------------------------------------------------------
def mainroot():
	#sroot.destroy()
	root = Tk()
	...
	#-----------------------------------------------------------------
		nl = Label(b_frame,text='Made by KATTA MURALI',fg='black',bg='gray91',font='msserif 8')
	...
	def staff():
		...
		Label(emp1inf,text="Mr. KATTA MURALI",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		...
		Label(emp1inf,text="Ms. jerome",bg='white',fg="Grey",font='msserif 10').place(x=45,y=37)
		...
		Label(emp1inf,text="Mr. Venkatesh (Head)",bg='white',fg="Grey",font='msserif 10').place(x=72,y=37)
		...
		Label(emp1inf,text="Ms. Swetha (Head)",bg='white',fg="Grey",font='msserif 10').place(x=55,y=37)
